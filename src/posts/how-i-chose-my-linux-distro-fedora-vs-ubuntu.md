...
Here's where things got interesting. Ubuntu's live ISO didn't recognize my Wi-Fi adapter at all. Without internet, I couldn't test the browser or download anything. Fedora, on the other hand, picked up the Wi-Fi instantly — no drivers, no fiddling around, just worked.
...
The webcam worked on both, but Ubuntu had it upside down. Fedora displayed it correctly and the image quality looked better too — colors and exposure just seemed more natural.
...
Ubuntu is solid and familiar, but its live ISO felt dated in comparison. The lack of Wi-Fi support, limited fractional scaling, missing gesture support, and that upside-down webcam all added up. Fedora, on the other hand, just worked — right from the start. Wi-Fi connected instantly, fractional scaling looked great, gestures worked perfectly, and everything felt faster and smoother.

Keep in mind, this was just a live USB test. I'll still install both distros properly to see how they perform long-term. But based on this first impression, Fedora is ahead by a significant margin. It feels like the distro that's better aligned with modern hardware and developer workflows in 2025.

Next up, I'll be documenting the full installation process and setting up my development environment. Stay tuned.

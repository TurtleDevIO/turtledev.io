...
<div class="bg-base-200 rounded-lg p-6 my-12">
	...
	<div class="mt-4 flex gap-3">
		<a href={siteConfig.socials.youtube} target="_blank" rel="noopener noreferrer"
			class="inline-flex items-center justify-center w-9 h-9 rounded-full bg-base-300 hover:bg-primary hover:text-primary-content transition-colors"
			aria-label="YouTube">
		...
		<a href={siteConfig.socials.kofi} target="_blank" rel="noopener noreferrer"
			class="inline-flex items-center justify-center w-9 h-9 rounded-full bg-base-300 hover:bg-primary hover:text-primary-content transition-colors"
			aria-label="Ko-fi">
			<svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
